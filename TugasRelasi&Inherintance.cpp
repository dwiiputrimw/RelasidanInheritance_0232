...
int main()
{
    ...
    admin* varAdmin = new admin("Imam", "Imam@gmail.com");
    member* varMember1 = new member("Auvar", "Auvar@gmail.com", "aktif");
    member* varMember2 = new member("Fathi", "Fathi@gmail.com", "nonaktif");
